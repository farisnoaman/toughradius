...
const customEnglishMessages: TranslationMessages = {
  ...
  resources: {
    ...
    'pppoe-profiles': {
      name: 'PPPoE Profile |||| PPPoE Profiles',
      fields: {
        id: 'ID',
        name: 'Profile Name',
        node_id: 'Node',
        status: 'Status',
        addr_pool: 'IPv4 Address Pool',
        ipv6_prefix_pool: 'IPv6 Prefix Pool',
        ipv6_addr_pool: 'IPv6 Address Pool',
        ac_name: 'AC Name',
        service_name: 'Service Name',
        session_timeout: 'Session Timeout (s)',
        idle_timeout: 'Idle Timeout (s)',
        interim_interval: 'Interim Interval (s)',
        up_rate: 'Upload Rate (Kbps)',
        down_rate: 'Download Rate (Kbps)',
        up_burst_rate: 'Upload Burst Rate',
        down_burst_rate: 'Download Burst Rate',
        up_burst_size: 'Upload Burst Size',
        down_burst_size: 'Download Burst Size',
        vlanid1: 'VLAN ID 1',
        vlanid2: 'VLAN ID 2',
        pvc_vpi: 'PVC VPI',
        pvc_vci: 'PVC VCI',
    ...
    'hotspot-profiles': {
      name: 'Hotspot Profile |||| Hotspot Profiles',
      fields: {
        id: 'ID',
        name: 'Profile Name',
        node_id: 'Node',
    ...
    'hotspot-users': {
      name: 'Hotspot User |||| Hotspot Users',
      fields: {
        id: 'ID',
        node_id: 'Node',
        profile_id: 'Profile',
