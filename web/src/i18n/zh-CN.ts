...
const customChineseMessages: TranslationMessages = {
  ...
  menu: {
    ...
    nas_devices: 'NAS设备',
    network_nodes: '网络节点',
    pppoe_profiles: 'PPPoE策略',
    pppoe_users: 'PPPoE用户',
    hotspot_profiles: 'Hotspot策略',
    hotspot_users: 'Hotspot用户',
    voucher_batches: '券码批次',
    system: '系统管理',
    operators: '操作员管理',
    system_config: '系统配置',
  ...
  resources: {
    ...
    'pppoe-profiles': {
      ...
      fields: {
        ...
        ipv6_addr_pool: 'IPv6地址池',
        ac_name: 'AC名称',
        service_name: '服务名称',
        session_timeout: '会话超时(秒)',
        idle_timeout: '空闲超时(秒)',
        interim_interval: '记账间隔(秒)',
        up_rate: '上行速率(Kbps)',
        down_rate: '下行速率(Kbps)',
        up_burst_rate: '上行突发速率',
        down_burst_rate: '下行突发速率',
        up_burst_size: '上行突发大小',
        down_burst_size: '下行突发大小',
        vlanid1: 'VLAN ID 1',
        vlanid2: 'VLAN ID 2',
        pvc_vpi: 'PVC VPI',
        pvc_vci: 'PVC VCI',
